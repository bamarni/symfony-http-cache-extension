...
abstract class HttpCache extends BaseHttpCache
{
    ...
    /**
     * Returns a doctrine cache driver that will be used by the HttpCache.
     *
     * @return \Doctrine\Common\Cache\Cache The cache storage driver.
     */
    protected function createStoreDriver()
    {
        throw new \RuntimeException('Please overwrite me.');
    }
}
